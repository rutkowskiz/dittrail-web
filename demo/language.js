const translations = {
    en: {
        ...
        stateText: "Learn is starting to become a real training path. The demo now includes First Signal, New Signals — I/M/S and O/A/N, Signal Check exercises that mix everything you already know, and Words on Air, where individual characters begin to turn into short CW words. Practice and Settings are also functional, while the rest of DitTrail is still being built.",
    ...
    de: {
        ...
        stateText: "Der Bereich Lernen entwickelt sich bereits zu einem echten Trainingspfad. Die Demo enthält First Signal, die Lektionen Neue Signale — I/M/S und O/A/N, Signal Check mit allen bisher gelernten Zeichen sowie Words on Air, wo aus einzelnen Zeichen erste kurze CW-Wörter werden. Üben und Einstellungen funktionieren ebenfalls; die übrigen Teile von DitTrail befinden sich weiter im Aufbau.",
    ...
    it: {
        ...
        stateText: "La sezione Impara sta già diventando un vero percorso di allenamento. La demo include First Signal, le lezioni Nuovi Segnali — I/M/S e O/A/N, gli esercizi Signal Check con tutti i caratteri già appresi e Words on Air, dove i singoli caratteri iniziano a diventare brevi parole in CW. Anche Pratica e Impostazioni sono disponibili, mentre il resto di DitTrail è ancora in sviluppo.",
    ...
    cs: {
        ...
        stateText: "Sekce Výuka už začíná tvořit skutečnou výukovou cestu. Demo obsahuje First Signal, lekce Nové Signály — I/M/S a O/A/N, cvičení Signal Check se všemi dosud naučenými znaky a Words on Air, kde se jednotlivé znaky začínají spojovat do krátkých CW slov. Trénink a Nastavení jsou také funkční, zatímco další části DitTrail se stále vyvíjejí.",
    ...
    es: {
        ...
        stateText: "La sección Aprende ya empieza a convertirse en una auténtica ruta de entrenamiento. La demo incluye First Signal, las lecciones Nuevas Señales — I/M/S y O/A/N, ejercicios Signal Check con todos los caracteres ya aprendidos y Words on Air, donde los caracteres individuales empiezan a convertirse en palabras cortas de CW. Práctica y Ajustes también funcionan, mientras el resto de DitTrail sigue en desarrollo.",
