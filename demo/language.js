const translations = {
    en: {
        ...
        stateText: "Learn now contains three complete post-First-Signal training cycles. The demo includes First Signal, New Signals — I/M/S, O/A/N and K/R/C, Signal Check exercises that mix everything you already know, and Words on Air with progressively longer CW words. Practice and Settings are also functional, while the rest of DitTrail is still being built.",
    ...
    pl: {
        ...
        stateText: "Sekcja Nauka zawiera już trzy pełne cykle treningowe po Pierwszym Sygnale. Demo obejmuje Pierwszy Sygnał, lekcje Nowe Znaki — I/M/S, O/A/N i K/R/C, ćwiczenia Sprawdź Znaki mieszające cały poznany materiał oraz Słowa w Eterze z coraz dłuższymi słowami CW. Trening i Ustawienia również działają, a pozostałe części DitTrail wciąż powstają.",
    ...
    de: {
        ...
        stateText: "Der Bereich Lernen enthält jetzt drei vollständige Trainingszyklen nach First Signal. Die Demo umfasst First Signal, New Signals — I/M/S, O/A/N und K/R/C, Signal Check mit allen bisher gelernten Zeichen sowie Words on Air mit zunehmend längeren CW-Wörtern. Üben und Einstellungen funktionieren ebenfalls; die übrigen Teile von DitTrail befinden sich weiter im Aufbau.",
    ...
    it: {
        ...
        stateText: "La sezione Impara contiene ora tre cicli di allenamento completi dopo First Signal. La demo include First Signal, New Signals — I/M/S, O/A/N e K/R/C, gli esercizi Signal Check con tutti i caratteri già appresi e Words on Air con parole CW progressivamente più lunghe. Anche Pratica e Impostazioni sono disponibili, mentre il resto di DitTrail è ancora in sviluppo.",
    ...
    cs: {
        ...
        stateText: "Sekce Výuka nyní obsahuje tři kompletní tréninkové cykly po First Signal. Demo zahrnuje First Signal, New Signals — I/M/S, O/A/N a K/R/C, cvičení Signal Check se všemi dosud naučenými znaky a Words on Air s postupně delšími CW slovy. Trénink a Nastavení jsou také funkční, zatímco další části DitTrail se stále vyvíjejí.",
    ...
    es: {
        ...
        stateText: "La sección Aprende contiene ahora tres ciclos completos de entrenamiento después de First Signal. La demo incluye First Signal, New Signals — I/M/S, O/A/N y K/R/C, ejercicios Signal Check con todos los caracteres ya aprendidos y Words on Air con palabras de CW progresivamente más largas. Práctica y Ajustes también funcionan, mientras el resto de DitTrail sigue en desarrollo.",
