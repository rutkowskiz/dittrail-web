const translations = {
    en: {
        ...
        stateSections: "Learn · Practice · Settings",
        stateText: "DitTrail Demo v0.9 now includes First Signal, three complete post-First-Signal learning cycles, Signal Check, Words on Air with progressively longer CW words, and Word Copy for recognizing whole CW words by ear. The Trail opens at the next available lesson, completed lessons remain replayable, and the currently running lesson is clearly marked. Practice and Settings are also functional, while the rest of DitTrail is still being built.",
        ...
        quickKey: "<strong>For the best results, connect a real telegraph key</strong> to your PC, for example through a USB adapter. If you do not have one yet, the keyboard is fine too — use <kbd>[</kbd> and <kbd>]</kbd>.",
    ...
    pl: {
        ...
        stateText: "DitTrail Demo v0.9 obejmuje już Pierwszy Sygnał, trzy pełne cykle Nauki po nim, Sprawdź Znaki, Słowa w Eterze z coraz dłuższymi słowami CW oraz Odbiór Słów, w którym rozpoznajesz całe słowa ze słuchu. Ścieżka po uruchomieniu pokazuje najnowszą dostępną lekcję, ukończone lekcje można powtarzać, a aktualnie uruchomiona lekcja jest wyraźnie oznaczona. Trening i Ustawienia również działają, a pozostałe części DitTrail wciąż powstają.",
        ...
        quickKey: "<strong>Najlepsze efekty uzyskasz z prawdziwym kluczem telegraficznym</strong> podłączonym do komputera, na przykład przez adapter USB. Jeśli jeszcze go nie masz, klawiatura też się nada — używaj klawiszy <kbd>[</kbd> i <kbd>]</kbd>.",
    ...
    de: {
        ...
        stateSections: "Lernen · Üben · Einstellungen",
        stateText: "DitTrail Demo v0.9 enthält jetzt First Signal, drei vollständige Lernzyklen danach, Signal Check, Words on Air mit zunehmend längeren CW-Wörtern und Word Copy zum Erkennen ganzer CW-Wörter nach Gehör. Der Trail öffnet sich bei der nächsten verfügbaren Lektion, abgeschlossene Lektionen können erneut gestartet werden und die aktuell laufende Lektion ist klar markiert. Üben und Einstellungen funktionieren ebenfalls; die übrigen Teile von DitTrail befinden sich weiter im Aufbau.",
        ...
        quickKey: "<strong>Die besten Ergebnisse erzielst du mit einer echten Morsetaste</strong>, die zum Beispiel über einen USB-Adapter mit dem PC verbunden ist. Wenn du noch keine hast, reicht auch die Tastatur — verwende <kbd>[</kbd> und <kbd>]</kbd>.",
    ...
    it: {
        ...
        stateSections: "Impara · Pratica · Impostazioni",
        stateText: "DitTrail Demo v0.9 include ora First Signal, tre cicli completi di apprendimento successivi, Signal Check, Words on Air con parole CW progressivamente più lunghe e Word Copy per riconoscere intere parole CW a orecchio. Il Trail si apre sulla prossima lezione disponibile, le lezioni completate possono essere ripetute e quella attualmente in esecuzione è chiaramente evidenziata. Anche Pratica e Impostazioni sono disponibili, mentre il resto di DitTrail è ancora in sviluppo.",
        ...
        quickKey: "<strong>Per ottenere i risultati migliori, collega un vero tasto telegrafico</strong> al PC, per esempio tramite un adattatore USB. Se non ne hai ancora uno, va bene anche la tastiera — usa <kbd>[</kbd> e <kbd>]</kbd>.",
    ...
    cs: {
        ...
        stateSections: "Výuka · Trénink · Nastavení",
        stateText: "DitTrail Demo v0.9 nyní obsahuje First Signal, tři kompletní navazující výukové cykly, Signal Check, Words on Air s postupně delšími CW slovy a Word Copy pro rozpoznávání celých CW slov sluchem. Trail se otevře u další dostupné lekce, dokončené lekce lze znovu spustit a právě probíhající lekce je jasně označena. Trénink a Nastavení jsou také funkční, zatímco další části DitTrail se stále vyvíjejí.",
        ...
        quickKey: "<strong>Nejlepších výsledků dosáhneš se skutečným telegrafním klíčem</strong> připojeným k počítači, například přes USB adaptér. Pokud ho zatím nemáš, stačí i klávesnice — používej <kbd>[</kbd> a <kbd>]</kbd>.",
    ...
    es: {
        ...
        stateSections: "Aprende · Práctica · Ajustes",
        stateText: "DitTrail Demo v0.9 incluye ahora First Signal, tres ciclos completos de aprendizaje posteriores, Signal Check, Words on Air con palabras de CW cada vez más largas y Word Copy para reconocer palabras CW completas de oído. El Trail se abre en la siguiente lección disponible, las lecciones completadas pueden repetirse y la lección que está en curso queda claramente marcada. Práctica y Ajustes también funcionan, mientras el resto de DitTrail sigue en desarrollo.",
        ...
        quickKey: "<strong>Para obtener los mejores resultados, conecta un manipulador telegráfico real</strong> al PC, por ejemplo mediante un adaptador USB. Si todavía no tienes uno, el teclado también sirve — usa <kbd>[</kbd> y <kbd>]</kbd>.",
