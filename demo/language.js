const translations = {
    en: {
        ...
        stateText: "The first lesson is now available in Learn. Practice and Settings are also functional. The remaining parts of the application are still under construction.",
    ...
    pl: {
        ...
        stateText: "W sekcji Nauka jest już dostępna pierwsza lekcja. Działają również zakładki Trening i Ustawienia. Pozostałe części programu są jeszcze w budowie.",
    ...
    de: {
        ...
        stateText: "Im Bereich Lernen ist jetzt die erste Lektion verfügbar. Auch Üben und Einstellungen funktionieren bereits. Die übrigen Teile der Anwendung befinden sich noch im Aufbau.",
    ...
    it: {
        ...
        stateText: "Nella sezione Impara è ora disponibile la prima lezione. Anche Pratica e Impostazioni sono già funzionanti. Le altre parti dell’applicazione sono ancora in costruzione.",
    ...
    cs: {
        ...
        stateText: "V sekci Výuka je nyní k dispozici první lekce. Trénink a Nastavení jsou také funkční. Ostatní části aplikace jsou stále ve vývoji.",
    ...
    es: {
        ...
        stateText: "La primera lección ya está disponible en la sección Aprende. Práctica y Ajustes también funcionan. El resto de la aplicación sigue en construcción.",
